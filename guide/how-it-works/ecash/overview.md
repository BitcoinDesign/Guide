...
**1.Generate a Token:**Generate a token for the desired amount in your Cashu or Fedimint wallet.

**2.Create a QR Code:**Convert the generated token into a QR code within your wallet.

**3.Share the QR Code:**The recipient scans the provided QR code using their Cashu or Fedimint wallet.

**4.Recipient Scans QR Code:**The recipient scans the provided QR code using their Cashu or Fedimint wallet.

**5.Transaction Completion::**The recipient’s wallet will automatically process and add the token to their balance, completing the transaction.
...
**2.Copy the Token String:**Copy the generated token string.

**3.Send the Token String:**Send the token string to the recipient through any communication channel (e.g., email, messaging app).

**4.Recipient Scans QR Code:**The recipient’s wallet will automatically process and add the token to their balance, completing the transaction.

**5.Recipient Actions:**
- **Copy the Token:** The recipient copies the ecash token string provided.
- **Paste into Wallet:** The recipient opens their Cashu or Fedimint wallet, navigates to the receive section, and pastes the token into the designated field.

**5.Transaction Completion:**The recipient’s wallet will validate and add the token to their balance, completing the transaction.

#### Sending via Lightning Network:
...
**1.**Get the LN invoice from the recipient.
...
#### Receiving Ecash by Paying a Lightning Network Invoice:
