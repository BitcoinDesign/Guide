...
They:
- Produce security verdicts on 3000+ mobile and hardware wallets
- Write in-depth documentation on the analysis of each wallet
- Maintain a high-quality security review methodology
- Provide navigation of wallets and verdicts via search
...
{% include picture.html
   ...
   alt-text = "An image of the research findings showing the search methods and seo terminology used by people"
   width = 800
   height = 220
   layout = "full-width"
%}
...
## Insights
**Consensus**: Design is an iterative process that requires the team being onboard with the direction of the design as well as the UX strategy. Building consensus was an essential part of the collaborative process.
